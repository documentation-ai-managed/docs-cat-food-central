...
description: >-
  Plant proteins, such as gluten, soy, and other vegetable-based proteins, are
  often used as inexpensive fillers and protein sources in dry cat foods.
---
However, these plant-based proteins are considered inferior to animal-based proteins for cats, as obligate carnivores.

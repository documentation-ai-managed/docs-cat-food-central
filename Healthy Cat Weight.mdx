...
Yes, significantly. Here are general healthy weight ranges by category:

| Category                                  | Typical Healthy Weight      |
| ----------------------------------------- | --------------------------- |
...
## Why Is My Cat Gaining Weight — or Losing It?

<Tabs>
  <Tab title="Gaining weight but not eating more">
    ### My Cat Is Gaining Weight But Not Eating More
    ...
    **What to do:** The first step is measuring what your cat actually eats — weigh food in grams, not estimate by cup. Review [Calories and Metabolizable Energy](/calories-and-metabolizable-energy-in-dry-cat-food) to understand how to calculate your cat's actual energy needs, and [Crude Fat](/crude-fat-in-dry-cat-food) to understand how fat content drives calorie density.
  </Tab>

  <Tab title="Losing weight but eating normally">
    ### My Cat Is Losing Weight But Still Eating Normally

    <Callout kind="alert" collapsed="false">
      Weight loss in a cat that is still eating normally is almost always a sign of an underlying medical condition — not a diet issue. This section covers the common causes. If your cat is losing weight without an obvious reason, see a veterinarian. A single exam with bloodwork will usually identify the cause.
    </Callout>

    When a cat eats normally but loses weight, the body is either absorbing nutrients poorly, burning through calories too fast, or both. The most common causes:

    **Hyperthyroidism** is the leading cause in cats over 10. The thyroid gland becomes overactive, flooding the body with thyroid hormone that dramatically increases metabolism. Affected cats are often ravenous — eating more than usual — yet losing weight because they're burning energy faster than they can consume it. Other signs include restlessness, increased vocalization, and a rough or unkempt coat.

    **Feline diabetes mellitus** can present similarly in some cases — the body cannot use glucose properly, so it turns to fat and muscle for fuel instead. Weight loss despite normal or increased appetite is a classic early sign.

    **Intestinal parasites** (roundworms, tapeworms, Giardia) interfere with nutrient absorption. A cat can eat adequate food but not absorb the calories and protein effectively. Common in cats with outdoor access or that hunt.

    **Dental pain** is frequently overlooked. A cat with severe dental disease or a painful mouth may appear to eat — approaching the bowl, spending time there — but actually consuming less than you realize because chewing is painful. Weight loss is gradual and easy to miss.

    **Inflammatory bowel disease (IBD)** damages the intestinal lining, reducing absorption. Chronic intermittent vomiting, loose stools, and progressive weight loss are typical.

    **Stress and behavioral causes** can reduce actual intake even when a cat "appears" to eat — particularly in multi-cat households where lower-ranking cats are displaced from food bowls.

    **Age-related muscle loss (sarcopenia)** in cats over 12 causes a gradual decline in body mass even with adequate intake. This is a normal part of aging in seniors and is different from the disease-driven weight loss above, though both can occur simultaneously.

    If your cat is older and losing weight while eating fine, "older cat losing weight but still eating" is a genuinely common situation — and the causes listed above account for the vast majority of cases. Bloodwork, including a thyroid panel, is the most efficient first step.
  </Tab>
</Tabs>
...
- Kittens that are neutered at 4–6 months may still need relatively high calories for growth — consult your vet about timing the reduction correctly.

- Weigh your cat monthly in the months after surgery. The weight gain associated with neutering typically becomes visible within 3–6 months if intake isn't adjusted.
...
**Dry food advantages:** Calorie content is listed clearly and is easier to measure precisely (by gram scale). Some cats won't eat wet food. Some weight-loss formulated dry foods are designed with appropriate protein-to-calorie ratios.
...
**Preserve protein.** Calorie restriction in cats risks muscle loss alongside fat loss. Higher-protein foods maintain lean body mass during a calorie deficit better than lower-protein equivalents. Look for foods where protein delivers a significant proportion of total calories, not just total weight. See [Crude Protein](/crude-protein-in-dry-cat-food).

**Fiber helps manage hunger.** Dietary fiber adds bulk and slows gastric emptying, helping cats feel fuller on fewer calories. Weight management formulas often have elevated fiber for this reason. See [Crude Fiber](/crude-fiber-in-dry-cat-food).

**"Light" or "indoor" foods aren't always the answer.** Some "light" formulations achieve lower calories by adding cheap fillers rather than by genuinely improving nutritional composition. A food with lower calories but poor protein quality isn't a better choice — just a less filling one. Compare ME values and protein percentages on a dry matter basis, not just the marketing label.
...
- **Food puzzle toys** make eating itself an activity. They slow down eating, reduce post-meal vomiting in fast-eaters, and add mild mental/physical exercise to mealtimes.
...
This is the hardest weight management scenario in feline care, and most resources give it two paragraphs of vague advice. It deserves more than that.
...
**Strategy 2: Microchip-activated feeders.** These feeders open only for the cat whose microchip or RFID collar tag is registered. A cat approaching another cat's feeder gets a closed lid. The technology is imperfect — some cats learn to hover while the registered cat eats and then dart in — but it works for most households. Cost is significant (£/$150–250+ per unit).
...
<Callout kind="alert" collapsed="false">
  Before attempting to help a cat gain weight, rule out a medical cause. Thinness in cats is often a symptom of something treatable — dental disease, parasites, hyperthyroidism, IBD, or stress. Increasing calories in a cat with an undiagnosed medical condition may not help, and delays the right treatment.
</Callout>
...
- **Increase meal frequency** before increasing portion size. 3–4 smaller meals per day is gentler on the digestive system and tends to produce better food acceptance than suddenly doubling one meal.
...
**How fast should a cat gain weight?** Gradual weight gain — 1–2% of body weight per week — is safer than rapid gain. A cat that gains weight too quickly may accumulate fat rather than lean muscle, which doesn't improve the underlying nutritional situation.
...
**During active weight loss or gain:** weigh every 2 weeks. This gives enough time for meaningful change to register while still catching problems early. Most veterinary weight loss protocols recommend a progress check every 4–8 weeks with a vet, with home weighing every 2 weeks in between.

**For senior cats (10+):** monthly weighting is especially important. Weight loss in older cats can be gradual and easy to miss until it's significant. A 3-month trend of slow decline is meaningful even if any single reading looked "close enough."
...
- Sudden weight loss of 0.5 kg or more in a week is always worth investigating, regardless of what the cat looks like or how it's behaving.
...
<ExpandableGroup>
  <Expandable title="Is 17 lbs (7.7 kg) too big for a cat?" default-open="false">
    For most domestic cats, yes. 17 lbs is significantly above the healthy weight range for average-framed domestic shorthairs and longhairs. The exception is large breeds — a male Maine Coon or Ragdoll at 17 lbs may be within or just slightly above their normal range. For a typical domestic cat at 17 lbs, this would represent substantial obesity with meaningful health risks. A BCS check and vet assessment would confirm the picture.
  </Expandable>

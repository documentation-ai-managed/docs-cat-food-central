...
description: "This rule awards points for the presence of an additional source of animal protein in the ingredients list, based on its position relative to the main meat i..."
---

This rule awards points for the presence of an additional source of animal protein in the ingredients list, based on its position relative to the main meat ingredient.
